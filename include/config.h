...
const uint8_t buttons_pins[num_buttons] = {32, 33, 25, 26, 27, 14, 12, 13, 23, 22, 21, 19, 18};
...
const uint16_t potentiometers_max_input_values[num_potentiometers] = {4095, 4095};
