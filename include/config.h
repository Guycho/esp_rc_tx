...
const uint8_t buttons_pins[num_buttons] = {23, 22, 12, 13, 21, 19, 18, 5, 17, 16, 4, 2, 15};
...
const uint8_t potentiometers_pins[num_potentiometers] = {36, 39};
...
const uint16_t potentiometers_max_input_values[num_potentiometers] = {
  uint16_t(pow(2, analog_read_resolution) - 1), uint16_t(pow(2, analog_read_resolution)- 1)};
